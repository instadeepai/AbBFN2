...
def process_prehumanisation(
    ...
    heavy_seqs = [mutate_seq_to_match_germline_likeness(seq, gl, target_score, allow_CDR_mutations, fixed_imgt_positions) for seq, gl in zip(heavy_seqs, h_germline_families)]
    light_seqs = [mutate_seq_to_match_germline_likeness(seq, gl, target_score, allow_CDR_mutations, fixed_imgt_positions) for seq, gl in zip(light_seqs, l_germline_families)]
